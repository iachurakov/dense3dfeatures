...
class HodgeNetModel(BaseModel):
    ...
    def __init__(self, num_edge_features, num_triangle_features,
                 ...
                 num_vector_dimensions=1, **basemodel_kwargs):
        ...
        self.head = nn.Sequential(
            nn.Conv1d(num_output_features * num_vector_dimensions**2, 512, 1),
            nn.BatchNorm1d(512),
            nn.ReLU(),
            nn.Conv1d(512, 512, 1)
        )
    ...
    def forward_impl(self, batch):
        ...
        return torch.nn.utils.rnn.pad_sequence(result, batch_first=True, padding_value=-1).transpose(2, 1)
