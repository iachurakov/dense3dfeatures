...
from .camera_pose import CameraPose, create_rotation_matrix_z, rotate_to_world_origin
from .spherical_spiral_sampling import spherical_spiral_sampling
from .fibonacci_sphere_sampling import fibonacci_sphere_sampling
...
class CompositePoseManager(AbstractCameraPoseManager):
    ...
    def from_config(cls, config):
        sequences = [
            POSE_MANAGER_BY_TYPE[sequence_config['type']].from_config(sequence_config)
